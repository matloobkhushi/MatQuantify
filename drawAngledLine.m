 % This function will use linear indexes to draw a straight HORIZONTAL or Perpendicular line though a point at given angle. 
...
function [index, xcoords, ycoords, bwmask]  = drawAngledLine(bwmask, point, len, angle, orientation)
